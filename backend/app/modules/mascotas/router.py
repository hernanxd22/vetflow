...
def get_todas_mascotas(
    ...
    if user.is_cliente:
        raise HTTPException(
            ...
            detail="Solo el personal de la clínica puede ver todas las mascotas",
        )
...
def create_mascota(
    ...
    return mascota_service.create(user.cliente_id, data, uow)
...
def get_mascotas(
    ...
    return mascota_service.get_all(user.cliente_id, uow)
...
def update_mascota(
    ...
    return mascota_service.update(mascota_id, user.cliente_id, data, uow)
...
def delete_mascota(
    ...
    return mascota_service.delete(mascota_id, user.cliente_id, uow)
